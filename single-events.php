		...
		<div class="sixteen columns">
			...
			<div class="room-content-description">
				...
				<div id="room-content-price">
					<?php printf( __( "from <span id='room-price'>%d<span>%s</span></span><span id='per-day'> /night</span>", "nation" ), $minPrice, $currencyCode ) ?>
				</div>
				...
				<form id="room-date-form" action="<?php echo get_permalink( $reservationID ) ?>" method="post">
					<div id="check-in-date-wrap">
						<input type="text" value="<?php _e("check-in date","nation") ?>" name="check-in" id="check-in-date" class="reservation-form-field">
					</div>
					<div id="check-out-date-wrap">
						<input type="text" value="<?php _e("check-out date","nation") ?>" name="check-out" id="check-out-date" class="reservation-form-field">
					</div>
					...
					<select name="room-children" id="single-room-children-selection">
						<option><?php _e("No. children","nation"); ?></option>
					...
					<div class="clear"></div>
					<input type="hidden" value="<?php echo get_post_meta(get_the_ID(),'max_person',true) ?>" name="max-person"><!--pass max person number-->
			...
			<div id="tabs-widget-wrap">
				<ul id="tabs">
					...
					<?php if ($roomFeatures) { ?><li><a href="#" name="#tab2"><?php _e('Features','nation'); ?></a></li><?php } ?>
					<?php if ($roomPolicies) { ?><li><a href="#" name="#tab3"><?php _e('Policies','nation'); ?></a></li><?php } ?>
